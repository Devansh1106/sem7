# Taken from https://github.com/cpraveen/numpde/blob/master/bvp2d/laplace_matrix.py\
"""
    Efficient approach to generate the sparse matrix in python
"""
...
print("Sparse Dxx ="); print(Dxx)
print("Full   Dxx ="); print(Dxx.todense())
